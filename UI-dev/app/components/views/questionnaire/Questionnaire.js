    ...
    setDataInState() {
        ...
        state["questions"] = [
              { 
                  ...
                  detail : "This service is currently only available in Boston. Please <a href='UnderConstruction' target='_blank'>Contact Us</a> if you'd like us to come to your city",
...
/*                      { 
    ...
    generateAnwsersContainer(id,type,answers,pid){
        ...
        switch(type) {
            case "dropdown":
                return (
                    <select className="btn ans_button backgroundHover color_1" data-qid={id} onChange={that.handleSelectChange}  data-pid={pid?pid:""} defaultValue={(that.state.answers[id]?that.state.answers[id]:"-1")}>
    ...
    render() {
        ...
        return (
            <DocumentTitle title="GIG Questions">
                <section className="questionnaire_container container-fluid">
